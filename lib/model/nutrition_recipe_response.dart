...
NutritionRecipeResponse nutritionRecipeResponseFromJson(String str) => NutritionRecipeResponse.fromJson(json.decode(str));

String nutritionRecipeResponseToJson(NutritionRecipeResponse data) => json.encode(data.toJson());
...
class NutritionRecipeResponse {
    ...
    factory NutritionRecipeResponse.fromJson(Map<String, dynamic> json) => NutritionRecipeResponse(
        calories: json["calories"],
        carbs: json["carbs"],
        fat: json["fat"],
        protein: json["protein"],
        bad: json["bad"] == null ? [] : List<Bad>.from(json["bad"]!.map((x) => Bad.fromJson(x))),
        good: json["good"] == null ? [] : List<Bad>.from(json["good"]!.map((x) => Bad.fromJson(x))),
        nutrients: json["nutrients"] == null ? [] : List<Flavonoid>.from(json["nutrients"]!.map((x) => Flavonoid.fromJson(x))),
        properties: json["properties"] == null ? [] : List<Flavonoid>.from(json["properties"]!.map((x) => Flavonoid.fromJson(x))),
        flavonoids: json["flavonoids"] == null ? [] : List<Flavonoid>.from(json["flavonoids"]!.map((x) => Flavonoid.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "good": good == null ? [] : List<dynamic>.from(good!.map((x) => x.toJson())),
        "nutrients": nutrients == null ? [] : List<dynamic>.from(nutrients!.map((x) => x.toJson())),
        "properties": properties == null ? [] : List<dynamic>.from(properties!.map((x) => x.toJson())),
        "flavonoids": flavonoids == null ? [] : List<dynamic>.from(flavonoids!.map((x) => x.toJson())),
